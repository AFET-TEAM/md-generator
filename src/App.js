...
function App() {
  ...
  // This prevents the React.memo in ProjectForm from being busted on App renders.
  ...
  const handleMultiAgentSubmit = React.useCallback((data) => {
    setProjectDataForAgents(data);
  }, []);
          ...
          <>
            {!projectDataForAgents && !loading && (
              <div className="multi-agent-intro">
                ...
                <ProjectForm onSubmit={handleMultiAgentSubmit} />
              </div>
            )}
