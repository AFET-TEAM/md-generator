...
function App() {
  ...
  // Performance Optimization: Wrap handleFormSubmit in useCallback to provide
  // a stable reference to ProjectForm, preventing it from re-rendering
  // on unrelated state updates like apiStatus.
