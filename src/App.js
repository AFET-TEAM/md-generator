...
function App() {
  ...
  // Performance Optimization: Wrapped handleFormSubmit in React.useCallback
  // to ensure its reference is stable and doesn't trigger unnecessary re-renders
  // of the memoized ProjectForm component.
