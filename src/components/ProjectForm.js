...
// Performance Optimization: Wrapped in React.memo to isolate this heavy form
// from unrelated re-renders in the parent component (e.g., App.js API status polling).
