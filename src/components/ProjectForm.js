...
// Performance Optimization: Wrap ProjectForm in React.memo to prevent unnecessary
// re-renders due to unrelated state updates in parent component (e.g. API health checks)
