...
// Performance Optimization: Wrapped in React.memo to prevent heavy form re-renders due to unrelated parent state updates in App.js (like initial apiStatus checks or mode changes).
